...
function FlashSale() {
  ...
  function getTimeRemaining() {
    ...
    const cycleMillis = 4 * 60 * 60 * 1000; // 4 hours
  ...
  const handleWishlistClick = (product) => {
    ...
    toggleWishlist(product); // update context
  };
  ...
  className="bg-white text-blue-700 hover:bg-gray-100 px-8 py-3 rounded-full font-bold text-sm flex items-center justify-center mx-auto shadow-lg transition"
>
